...
Write-Host "This will also install 7zip as a dependancy. Please accept the UAC prompt if/when you see it."
Write-Host "`n"
Pause
# TLS 1.2 Support for older OS + 7zip Command Line Install for Server 2012R2
...
function SteamCMD {
    ...
    &'C:\Program Files\7-Zip\7z.exe' x -aoa SteamCMD.zip
...
function OxideInstall {
    ...
    &'C:\Program Files\7-Zip\7z.exe' x -aoa OxideMod.zip
    Remove-Item OxideMod.zip
    $OxideDontTouch = "oxide_donttouch.ps1"
...
pause
cd /d $ForceInstall
powershell -file oxide_donttouch.ps1
powershell -command "&'C:\Program Files\7-Zip\7z.exe' x -aoa OxideMod.zip"
del OxideMod.zip
echo.
echo Oxide Updated!
echo.
...
$OxideDontTouchContent = @"
# This file is used to update Oxide. DO NOT EDIT IT.
[Net.ServicePointManager]::SecurityProtocol = [Net.SecurityProtocolType]::Tls, [Net.SecurityProtocolType]::Tls11, [Net.SecurityProtocolType]::Tls12, [Net.SecurityProtocolType]::Ssl3
[Net.ServicePointManager]::SecurityProtocol = "Tls, Tls11, Tls12, Ssl3"
Invoke-WebRequest https://umod.org/games/rust/download -OutFile 'OxideMod.zip'
"@
    Set-Content $OxideDontTouch $OxideDontTouchContent
    Clear-Host
